...
public class Solution {
	...
	public static ArrayList<ArrayList<Integer>> levelorder2(TreeNode n) {
		java.util.Queue<TreeNode> nodequeue = new java.util.LinkedList<TreeNode>();
		if (n != null)
			nodequeue.add(n);
		while (!nodequeue.isEmpty()) {
	...
	public ArrayList<ArrayList<Integer>> levelOrderBottom2(TreeNode root) {
		...
		if (root == null)
			return ret;
		l.add(new ArrayList<TreeNode>(java.util.Arrays
				.asList(new TreeNode[] { root })));
